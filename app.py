...
if uploaded_file is not None:
    try:
        ...
        if not df_filtrado_fecha.empty:
            ...
            # tonelaje_por_producto_detail = pd.DataFrame() # Este se elimina ya que se integra en el combinado
            tonelaje_por_producto_detail = pd.DataFrame() # Lo mantenemos por si acaso para otros usos
            ...
            # 3. Gráfico por Cantidad de Guías Emitidas por Producto (AHORA SE INTEGRA AL COMBINADO)
            ...
            if not tonelaje_por_producto_detail.empty:
                ...
                # Si quieres combinarlo con guías, la lógica está en el siguiente punto.
