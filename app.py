...
if uploaded_file is not None:
    try:
        ...
        if not df_filtrado_fecha.empty:
            ...
            # tonelaje_por_producto_detail = pd.DataFrame() # Este gráfico se ha eliminado
            tonelaje_por_producto_detail = pd.DataFrame() # Lo mantenemos para el gráfico combinado de producto
            ...
            # 3. Gráfico por Cantidad de Guías Emitidas por Producto (ESTE GRÁFICO SE ELIMINA COMPLETAMENTE)
            # El cálculo se mantiene por si es necesario para insights, pero el código para graficarlo se ha eliminado.
            if GUIA_COLUMN_IDENTIFIER and GUIA_COLUMN_IDENTIFIER in df_filtrado_fecha.columns:
            ...
            # El código que generaba el gráfico individual de guías por producto ha sido ELIMINADO FÍSICAMENTE.
